...
urlpatterns = [
    ...
    path('strategies/', views.ListViewStrategy.as_view(), name='strategies'),
    path('strategy/<uuid:pk>/', views.DetailViewStrategy.as_view(), name='strategy'),
    path('create-strategy/', views.CreateViewStrategy.as_view(), name='create_strategy'),
    path('update-strategy/<uuid:pk>/', views.UpdateViewStrategy.as_view(), name='update_strategy'),
    path('delete-strategy/<uuid:pk>/', views.DeleteViewStrategy.as_view(), name='delete_strategy'),

    path('pillars/', views.ListViewPillars.as_view(), name='pillars'),
