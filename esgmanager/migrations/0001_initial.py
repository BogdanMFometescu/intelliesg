    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1, help_text="Scale from 1 (Low) to 10 (High)"
                    ),
                ),
                (
                    "cc_severity",
                ...
                (
                    "cc_mitigation_measures",
                    models.TextField(default="mitigation measure"),
                ),
                (
                    "cc_opportunities",
                    models.TextField(blank=True, default="opportunities", null=True),
                ),
                (
                    "cc_responsible",
                    models.CharField(default="responsible", max_length=255),
                ),
                (
                    "id",
                    models.UUIDField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="esgmanager.esgactionplanobjectives",
                    ),
                ),
                (
                    "pillar",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="esgmanager.esgpillars"
            ),
        ),
        migrations.CreateModel(
            name="ESGStrategy",
