...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "measure_unit",
                    models.CharField(
                        choices=[("L", "L"), ("kwh", "kwh")], max_length=25
                    ),
                ),
                (
                    "company",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("Diesel passenger cars", "Diesel passenger cars"),
                            ...
                            (
                                ...
                                "Diesel-medium-and-heavy-Vehicles",
                            ),
                            (
                            ...
                            (
                                "Gasoline medium-and-heavy-trucks",
                                "Gasoline medium-and-heavy-trucks",
                            ),
                            (
                            ...
                            (
                                ...
                                "Gasoline-medium-and-heavy-Vehicles",
                            ),
                            (
        ...
        migrations.CreateModel(
            name="FuelEnergyRelatedActivities",
            fields=[
                ("created", models.DateField(auto_now_add=True)),
                ("updated", models.DateField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "net_zero_year",
                    models.IntegerField(blank=True, default=2050, null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "currency",
                    models.CharField(
                        choices=[("EUR", "EUR"), ("USD", "USD"), ("RON", "RON")],
                        max_length=10,
                    ),
                ),
                ...
                (
                    "climate_change_dnsh",
                    models.CharField(
                        choices=[("Yes", "Yes"), ("No", "No")], max_length=255
                    ),
                ),
                (
                    "marine_resources_dnsh",
                    models.CharField(
                        choices=[("Yes", "Yes"), ("No", "No")], max_length=255
                    ),
                ),
                (
                    "circular_economy_dnsh",
                    models.CharField(
                        choices=[("Yes", "Yes"), ("No", "No")], max_length=255
                    ),
                ),
